...
<main id="profile_partner" class="page ">
    <div class=" bg-white p-8 rounded shadow-md">
        ...
        <form onsubmit="return validate(event, update)" method="post">
            ...
            <div class="flex justify-between">
                ...
                <button class="bg-red-500 text-white p-2 rounded w-30 px-4" onclick="delete_user(<?= $_SESSION['user']['user_id'] ?>)" <?php if ($_SESSION['user']['user_role'] == "admin") echo 'class="hidden"'; ?>>Delete user</button>
            </div>
        </form>
    </div>
